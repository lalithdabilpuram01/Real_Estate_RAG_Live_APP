...
├── rag.py             # Core RAG pipeline (LangChain, ChromaDB, HuggingFace)
├── prompt.py          # Custom prompt templates (Under development)
...
2. Install the required dependencies:
   ```bash
   pip install langchain-classic langchain-community langchain-groq langchain-chroma langchain-huggingface unstructured streamlit python-dotenv
   ```
